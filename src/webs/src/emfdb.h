 ...
 */
extern int		dbRegisterDBSchema(int did, dbTable_t *sTable);
...
extern void*    dbGetRowPtr(int did, char_t *table, int row );
extern void     dbUpdateStr( char_t** ptr, char_t* new_value );
...
extern char_t	*basicGetProductDir(int did);
extern void		basicSetProductDir(int did, char_t *proddir);
